...
const CurrentProject = ({route,navigation}) => {
  ...
  const technologyArray = lookupData ? lookupData.primaryTechnology : [];
    ...
    // let managerDetail = projectArray[i].managerDetails;
      ...
      <View style={{marginTop:12}}>
        ...
        <View style={{backgroundColor:ThemeColor.ViewBgColor, height:40, borderRadius:5, flexDirection:'row', alignItems:'center', paddingRight:8, backgroundColor:'white'}}>
            ...
            <View style={{backgroundColor:'white',  borderRadius:5, flexDirection:'row', alignItems:'center'}} >
              <Picker
                ...
                onValueChange={(itemValue, index) =>{
                  ...
                  setProjectDetail({...projectDetail,technology:selectedItem.technologyName ,technologyId:selectedItem.technologyId});
                }}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{flexDirection:'row',borderRadius:5,marginLeft:16, marginRight:16, marginBottom:16}}>
        <TouchableOpacity style={[styles.btnFill,{backgroundColor:'white',borderTopLeftRadius:5,borderBottomLeftRadius:5}]} onPress={() => skipOnboarding()}>
          <Text style={{color:'#53962E',fontFamily: FontName.Regular, fontSize:16, color:ThemeColor.BtnColor }}>SKIP</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.btnFill,{borderBottomRightRadius:5,borderTopRightRadius:5}]} onPress={() => {updateProjectDetails()}}>
